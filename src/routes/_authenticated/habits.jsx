...
const TABS = [
  { to: '/habits/', label: 'Today', icon: LayoutGrid, exact: true },
  { to: '/habits/library', label: 'Library', icon: BookOpen },
  { to: '/habits/analytics', label: 'Analytics', icon: BarChart2 },
  { to: '/habits/dhikr', label: 'Dhikr', icon: Sparkles },
]
