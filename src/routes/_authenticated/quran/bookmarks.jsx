...
export const Route = createFileRoute('/_authenticated/quran/bookmarks')({
    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-2 pt-4">
      ...
      {isLoading ? (
        ...
        <div className="text-center py-20 border-2 border-dashed border-border rounded-3xl bg-muted/20">
          ...
          {!activeFolderId && (
            <Button variant="outline" size="sm" onClick={() => navigate({ to: '/quran' })}>
          ...
          {bookmarks.map(b => {
            ...
            return (
              <Card
                ...
                onClick={() => navigate({ to: '/quran/surah/$id', params: { id: String(b.surah_number) }, search: { ayah: b.ayah_number } })}
              >
