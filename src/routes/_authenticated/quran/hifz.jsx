...
export const Route = createFileRoute('/_authenticated/quran/hifz')({
  component: HifzTab,
})
            ...
            <Card key={e.id} className="p-4 border-orange-500/20 bg-orange-500/5">
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="flex items-center gap-2">
                  <button
                    onClick={() => navigate({ to: '/quran/surah/$id', params: { id: String(e.surah_number) } })}
                ...
                {expandedId === e.id && (
                  <div className="px-4 pb-4 border-t border-border/50 pt-3 space-y-3 animate-in slide-in-from-top-1">
                    ...
                    <div className="flex gap-2">
                      <Button size="sm" variant="outline" className="flex-1" onClick={() => navigate({ to: '/quran/surah/$id', params: { id: String(e.surah_number) } })}>
                        <BookOpen className="h-3.5 w-3.5 mr-1.5" /> Open Surah
                      </Button>
                      <Button size="sm" variant="outline" className="flex-1" onClick={() => navigate({ to: '/quran/surah/$id', params: { id: String(e.surah_number) }, search: { hifzMode: 'hide' } })}>
