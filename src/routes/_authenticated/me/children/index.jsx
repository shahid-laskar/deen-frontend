  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-end justify-between flex-wrap gap-4 animate-slide-up">
        ...
        <div className="flex gap-2">
          <Link
            to="/me/children/kids-mode"
            className="flex items-center gap-2 rounded-2xl bg-gold text-gold-foreground px-5 py-3 text-sm font-bold shadow-glow-gold hover:opacity-90 transition-all"
          >
            <Feather className="h-4 w-4" /> Kids Mode
          </Link>
          <button
