...
export const Route = createFileRoute('/_authenticated/me/children/$childId')({
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          <Link to="/worship/quran" className="flex items-center gap-1.5 px-4 h-9 rounded-xl border border-border/50 text-xs font-bold text-muted-foreground hover:bg-muted/50 transition-colors">
...
export default function ChildDetailPage() {
  ...
  if (!child) return (
    <div className="text-center py-20 text-muted-foreground">
      ...
      <Link to="/me/children/" className="text-primary font-bold text-sm mt-2 block">← Back to children</Link>
    </div>
  )
  ...
  return (
    <div className={cn("space-y-6 animate-slide-up p-4 sm:p-6 rounded-3xl border border-border/40 min-h-screen", themeClass)}>
      {/* Back + Header */}
      <div>
        <Link to="/me/children/" className="flex items-center gap-1.5 text-xs font-bold text-muted-foreground hover:text-foreground mb-4">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col items-end gap-2 shrink-0">
            ...
            <Link to="/me/children/kids-mode" className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-primary hover:bg-primary/90 text-white shadow-glow-primary transition-all hover:scale-105 active:scale-95">
