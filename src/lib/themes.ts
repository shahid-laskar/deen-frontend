...
export type IconPackId = "lucide" | "lucide-filled" | "phosphor" | "phosphor-duotone" | "tabler" | "hugeicons" | "remix" | "iconoir";
...
export const THEMES: Theme[] = [
  ...
  { id: "andalusian-azure", name: "Andalusian Azure", tagline: "Moorish cobalt + ochre + zellige white", category: "traditional", swatches: ["#1E4FB8", "#F0F4F8", "#C89340", "#3FA3A3"], motif: "zellige", icons: "remix", typeset: "royal" },
  ...
  { id: "saffron-bazaar", name: "Saffron Bazaar", tagline: "Saffron + indigo + rose + cream", category: "traditional", swatches: ["#E8974A", "#F6EBD8", "#5A4B8E", "#C04858"], motif: "arabesque", icons: "remix", typeset: "editorial" },
  
  // 9-14 Modern
  { id: "sahara-minimal", name: "Sahara Minimal", tagline: "Off-white + graphite + single saffron accent", category: "modern", swatches: ["#FAFAF7", "#1A1A1A", "#E88B2C", "#8A8A85"], motif: "hex", icons: "iconoir", typeset: "modern" },
  { id: "nordic-masjid", name: "Nordic Masjid", tagline: "Fjord slate + matte gold + chalk", category: "modern", swatches: ["#5A7A94", "#EEF2F4", "#B89358", "#8FA8B5"], motif: "lattice", icons: "hugeicons", typeset: "modern" },
  ...
  { id: "vercel-mono", name: "Vercel Mono", tagline: "Black/white + single cyan accent", category: "modern", swatches: ["#FFFFFF", "#000000", "#0070F3", "#888888"], motif: "hex", icons: "iconoir", typeset: "modern" },
  ...
  { id: "mist-ink", name: "Mist Ink", tagline: "Soft grey-blue + deep ink + blush", category: "modern", swatches: ["#E8ECEF", "#2A2F3A", "#C88B8B", "#6B7A94"], motif: "lattice", icons: "hugeicons", typeset: "geometric" },
  ...
  { id: "platinum-silk", name: "Platinum Silk", tagline: "Platinum + champagne + soft mauve", category: "luxury", swatches: ["#E6E4DE", "#8C7A5E", "#B8A890", "#6E5E7E"], motif: "arabesque", icons: "iconoir", typeset: "royal" },
  ...
  { id: "ocean-tasbih", name: "Ocean Tasbih", tagline: "Ocean blue + foam + coral + deep teal", category: "nature", swatches: ["#1E6E8E", "#E8F2F4", "#E88B6E", "#0E3E5A"], motif: "lattice", icons: "remix", typeset: "modern" },
  { id: "mountain-fajr", name: "Mountain Fajr", tagline: "Misty blue + pine + granite + snow", category: "nature", swatches: ["#5A7A8E", "#F0F2F0", "#3E5E4A", "#8E9AA0"], motif: "hex", icons: "hugeicons", typeset: "geometric" },
  ...
  { id: "spring-rayhan", name: "Spring Rayhan", tagline: "Fresh green + lemon + sky + cream", category: "nature", swatches: ["#4A9E6E", "#F8F4D8", "#7EB8E8", "#E8D458"], motif: "quatrefoil", icons: "tabler", typeset: "soft" },
  { id: "winter-sakina", name: "Winter Sakina", tagline: "Icy blue + silver + slate + snow", category: "nature", swatches: ["#B8CEDE", "#E8EEF2", "#5E7A8E", "#2E3E4E"], motif: "star-8", icons: "iconoir", typeset: "modern" },
];
