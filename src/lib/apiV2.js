// V2 + V3 API helpers
// NOTE: These extend the base `api` instance from api.js
import api from './api'
...
export const qiblaApi = {
  ...
  nearbyMosques: (lat, lng, radius)  => api.get('/qibla/mosques', { params: { lat, lng, radius_m: radius } }),
  mosquesNearMe: (radius)            => api.get('/qibla/mosques/nearby', { params: { radius_m: radius } }),
}
